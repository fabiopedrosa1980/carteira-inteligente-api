...
O sistema SHALL permitir ordenar a listagem por nota (descendente) ou variação do dia via query parameter `sort`.
...
- **THEN** o sistema SHALL retornar 400 Bad Request com mensagem indicando valores aceitos
